...
--
-- Servidor: 127.0.0.1
-- Tempo de Geração: Fev 08, 2016 as 09:04 PM
...
--
-- Banco de Dados: `openbiblio`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `biblio`
--
...
--
-- Extraindo dados da tabela `biblio`
--
...
(1, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 2, '005.4', 'Gil', NULL, 'UNIX in a Nutshell', 'A Desktop Quick Reference for System V & Solaris 2.0', 'Daniel Gilly and the staff of OReilly & Associates, Inc.', 'Gilly,Daniel', 'Unix', 'Computers', 'Operating Systems', NULL, NULL, 'Y'),
(2, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 2, '005.4', 'Fla', NULL, 'Java in a Nutshell', 'A Desktop Quick Reference', 'David Lanagan', 'Flanagan, David', 'Java', 'Computers', 'Programming', 'Programming Languages', NULL, 'Y'),
(3, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 2, '005.4', 'Gam', NULL, 'Design Patterns', 'Elements of Reusable Object-Oriented Software', 'Erich Gamma, Richard Helm, Ralph Johnson, John Vlissides', 'Gamma, Erich', 'Object-Oriented', 'Programming', 'Software Design', NULL, NULL, 'Y'),
(4, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 2, '005.4', 'Lar', NULL, 'Applying UML and Patterns', 'An Introduction to Object Oriented Analysis and Design', 'Craig Larman', 'Larman, Craig', 'Object-Oriented', 'Programming', 'Software Design', 'UML', NULL, 'Y'),
(5, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 7, 'JF', 'Cle', NULL, 'Ribsy', NULL, 'Beverly Cleary, Illustrated by Louis Darling', 'Cleary,Beverly', 'dogs', 'fiction', NULL, NULL, NULL, 'Y'),
(6, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 2, 7, 'JF', 'Cle', NULL, 'Henry Huggins', NULL, 'Beverly Cleary, Illustrated by Louis Darling', 'Cleary,Beverly', 'fiction', 'dogs', NULL, NULL, NULL, 'Y'),
(7, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 6, 10, 'P', 'PCW', NULL, 'PC World (Periodical):2003', NULL, 'PC World Communications, Inc.', NULL, 'computers', 'personal computing', 'periodicals', NULL, NULL, 'Y'),
(8, '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 6, 10, 'P', 'PCW', NULL, 'U.S. News & World Report (Periodical):2003', NULL, 'U.S. News & World Report', NULL, 'periodicals', 'news', NULL, NULL, NULL, 'Y');

-- --------------------------------------------------------

--
-- Estrutura da tabela `biblio_copy`
--
...
--
-- Extraindo dados da tabela `biblio_copy`
--
...
(1, 1, '2014-02-26 22:05:10', NULL, '101', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(2, 1, '2014-02-26 22:05:10', NULL, '102', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(3, 1, '2014-02-26 22:05:10', NULL, '103', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(4, 1, '2014-02-26 22:05:10', NULL, '104', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(5, 1, '2014-02-26 22:05:10', NULL, '105', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(6, 1, '2014-02-26 22:05:10', NULL, '106', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(7, 1, '2014-02-26 22:05:10', 'Jan', '201', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(7, 2, '2014-02-26 22:05:10', 'Feb', '202', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(7, 3, '2014-02-26 22:05:10', 'Mar', '203', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(8, 1, '2014-02-26 22:05:10', '1/20', '210', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(8, 2, '2014-02-26 22:05:10', '1/27', '211', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(8, 3, '2014-02-26 22:05:10', '2/10', '212', 'in', '2014-02-26 22:05:10', NULL, NULL, 0),
(8, 4, '2014-02-26 22:05:10', '2/17', '213', 'in', '2014-02-26 22:05:10', NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `biblio_copy_fields`
--
...
--
-- Extraindo dados da tabela `biblio_copy_fields`
--
...
--
-- Estrutura da tabela `biblio_copy_fields_dm`
--
...
--
-- Extraindo dados da tabela `biblio_copy_fields_dm`
--
...
--
-- Estrutura da tabela `biblio_field`
--
...
--
-- Extraindo dados da tabela `biblio_field`
--
...
--
-- Estrutura da tabela `biblio_hold`
--
...
--
-- Extraindo dados da tabela `biblio_hold`
--
...
--
-- Estrutura da tabela `biblio_status_dm`
--
...
--
-- Extraindo dados da tabela `biblio_status_dm`
--
...
--
-- Estrutura da tabela `biblio_status_hist`
--
...
--
-- Extraindo dados da tabela `biblio_status_hist`
--
...
--
-- Estrutura da tabela `checkout_privs`
--
...
--
-- Extraindo dados da tabela `checkout_privs`
--
...
--
-- Estrutura da tabela `collection_dm`
--
...
--
-- Extraindo dados da tabela `collection_dm`
--
...
--
-- Estrutura da tabela `material_type_dm`
--
...
--
-- Extraindo dados da tabela `material_type_dm`
--
...
--
-- Estrutura da tabela `material_usmarc_xref`
--
...
--
-- Extraindo dados da tabela `material_usmarc_xref`
--
...
--
-- Estrutura da tabela `mbr_classify_dm`
--
...
--
-- Extraindo dados da tabela `mbr_classify_dm`
--
...
(1, '101', '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 'Cat', 'Huckle', '101 1st Street\nBusyTown,IA 12345', '111-222-3333', NULL, 'me@mydomain.name', 2),
(2, '102', '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 'Baggins', 'Bilbo', 'Hole 1, 1st Street\nThe Shire, IA 12345', '111-222-3333', NULL, 'me@mydomain.name', 1),
(3, '103', '2014-02-26 22:05:10', '2014-02-26 22:05:10', 1, 'Baggins', 'Frodo', 'Hole 2, 1st Street\nThe Shire, IA 12345', '111-222-3333', NULL, 'me@mydomain.name', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `member_account`
--
...
--
-- Extraindo dados da tabela `member_account`
--
...
--
-- Estrutura da tabela `member_fields`
--
...
--
-- Extraindo dados da tabela `member_fields`
--
...
--
-- Estrutura da tabela `member_fields_dm`
--
...
--
-- Extraindo dados da tabela `member_fields_dm`
--
...
('Brailleteca', '../images/logo_braille_small.png', 'N', 'Seg a sex das 8:00 as 17:30', '(53) 3222-1474', '', '../opac/index.php', 20, 10, '0.7.1', 1, 6, 'Y', 14, 'pt_BR', 'UTF-8', 'pt-br');
...
(1, '2014-02-26 22:05:07', '2014-02-26 22:05:07', 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Root Administrator', NULL, 'N', 'Y', 'Y', 'Y', 'Y', 'Y');
...
(1, 'Mossy Blue', '#7695C0', 'Arial,Helvetica,sans-serif', 40, 'N', '#ffffff', 'left', '#ffffff', 'verdana,arial,helvetica', 13, '#000000', '#0000aa', '#990000', '#7BC5A0', 'verdana,arial,helvetica', 13, '#000000', '#0000aa', '#003366', 'verdana,arial,helvetica', 13, '#ffffff', '#ffffff', 'Y', '#000000', 1, 2),
...
--
-- Estrutura da tabela `transaction_type_dm`
--
...
--
-- Extraindo dados da tabela `transaction_type_dm`
--
...
--
-- Estrutura da tabela `usmarc_block_dm`
--
...
--
-- Extraindo dados da tabela `usmarc_block_dm`
--
...
--
-- Estrutura da tabela `usmarc_indicator_dm`
--
...
--
-- Extraindo dados da tabela `usmarc_indicator_dm`
--
...
--
-- Estrutura da tabela `usmarc_subfield_dm`
--
...
--
-- Extraindo dados da tabela `usmarc_subfield_dm`
--
...
--
-- Estrutura da tabela `usmarc_tag_dm`
--
...
--
-- Extraindo dados da tabela `usmarc_tag_dm`
--
